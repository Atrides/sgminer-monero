...
_clState *initCl(unsigned int gpu, char *name, size_t nameSize)
{
	...
	applog(LOG_WARNING, "Kernel cryptonight is experimental.");
	strcpy(filename, CRYPTONIGHT_KERNNAME".cl");
	strcpy(binaryfilename, CRYPTONIGHT_KERNNAME);
