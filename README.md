...
CryptoNight-version (Monero & Co). Made by Atrides for Monero-Pool www.dwarfpool.com/xmr
Code based on djm34-code which based on lasybear-code which based on phm-code which based on sgminer-dev :)))

Currently not works because of some errors in OpenCL-file.
Also supported only RPCv1 now, on dwarfpool it's port 8001

**If you satisfied, please donate**

XMR: 44nAsUDkWigVPY3Hkv2TGUAvYUDcST66bhCPLRMyod2y4oEEWJwsrA9ZqtmWsHZu1LRMNccu5RTJbhYKHuzVgs6QEZHUdrL
